...
export interface Paper {
  ...
  authors?: string[]; // "First Last", same shape and order as a publication's
  ...
  papersCards: [
    {
      ...
      footerLink: [
        // Named "Paper" rather than "arXiv", which is what the placeholder
        // here suggested, so it reads the same as the Paper link on the
        // peer-reviewed cards: both point at the version of record, whether
        // that is a DOI or, for a preprint, the arXiv abstract page.
        {
          name: "Paper",
          url: "https://arxiv.org/abs/2608.24480",
        },
        {
          name: "Code",
    ...
    },
    {
      ...
      paperPdf: "/pdfs/preprint_SELF_2016_blockchain_overview.pdf",
      footerLink: [],
    },
    {
      title:
